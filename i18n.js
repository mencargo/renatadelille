...
const translations = {
  es: {
    ...
    "services.s2.title":        "Orientación familiar",
    ...
    "services.modalities_label":"Modalidades de acompañamiento",
    "services.mod1":            "Sesión individual · 50 min",
    "services.mod2":            "Presencial en Cuernavaca, México",
    "services.mod3":            "Virtual por Zoom",
    "services.mod4":            "$600 por sesión",
    "services.mod5":            "$2,000 mensual · 4 sesiones",
    "services.mod6":            "Talleres y programas escolares",
  ...
  en: {
    ...
    "services.s2.title":        "Family guidance",
    ...
    "services.modalities_label":"Engagement modalities",
    "services.mod1":            "Individual session · 50 min",
    "services.mod2":            "In-person in Cuernavaca, Mexico",
    "services.mod3":            "Online via Zoom",
    "services.mod4":            "$600 per session",
    "services.mod5":            "$2,000/month · 4 sessions",
